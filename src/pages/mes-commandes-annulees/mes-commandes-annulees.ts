...
@IonicPage()
@Component({
  selector: 'page-mes-commandes-annulees',
  templateUrl: 'mes-commandes-annulees.html',
})
export class MesCommandesAnnuleesPage {
  data = [];
  reservations:any;
  ...
  getReservations(){
    ...
    let headers = new Headers();
      ...
      this.http.get(apiKey+'user/reservationsannulees/'+res.id).map(res => res.json())
        .subscribe(data => {
