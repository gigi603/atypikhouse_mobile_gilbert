...
@IonicPage()
@Component({
  selector: 'page-mes-commandes-passees',
  templateUrl: 'mes-commandes-passees.html',
})
export class MesCommandesPasseesPage {
  data = [];
  reservations:any;
  ...
  getReservations(){
    ...
    let headers = new Headers();
      ...
      this.http.get(apiKey+'user/reservationspassees/'+res.id).map(res => res.json())
        .subscribe(data => {
